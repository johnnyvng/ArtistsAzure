            ...
            <div class="col-md-8 pdl pdr">
              ...
              <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Featured Services <span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="goverment.html">Government</a></li>
                        <li><a href="largeestate.html">Large Estate</a></li>
